...
class MoveBaseCarrotPlannerServer:
    ...
    def execute(self, goal):
        ...
        dx = goal.target_pose.pose.position.x - starting_pose.pose.position.x
        dy = goal.target_pose.pose.position.y - starting_pose.pose.position.y
        ...
        while not self.server.is_preempt_requested():
            ...
            next_goal.target_pose = copy.deepcopy(goal.target_pose)
